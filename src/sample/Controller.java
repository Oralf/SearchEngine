...
public class Controller {
    ...
    public void browseQueryFile(){
        ...
        if(selectedFile != null){
            ...
            file_query_text_field.setText(queryPath);
        }
    }
   ...
   private void deleteAll(File folder){
    ...
    public void uploadDictionary(ActionEvent event){
        ...
        if(!folder.exists()){
            ...
            if(indexer==null){
                indexer=new Indexer(corpusPath,postingPath,stemming_checkBox.isSelected());
            }
    ...
    public void runSingleQuery(){
        if(single_query_text_field.getText().trim().isEmpty()){
            ...
            Searcher searcher;
            if(stemming_checkBox.isSelected()){
                searcher=new Searcher(semantic_search_checkbox.isSelected(),entities_checkbox.isSelected(),stemming_checkBox.isSelected(),postingPath+"\\withStemmer",indexer);
            } else{
                searcher=new Searcher(semantic_search_checkbox.isSelected(),entities_checkbox.isSelected(),stemming_checkBox.isSelected(),postingPath+"\\noStemmer",indexer);
            }
    ...
    public void runFileQuery(){
        if(file_query_text_field.getText().trim().isEmpty()){
            ...
            LinkedHashMap<String,LinkedHashMap<String, List<Pair<String, Double>>>> queryAns= searcher.searchFileQuery(queryPath);
